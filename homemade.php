...
<html lang="en">
	...
	<body>
			...
			<div class="collapse navbar-collapse  justify-content-end" id="collapsibleNavbar">
				<ul class="navbar-nav" data-aos="";>
					...
					<li class="nav-item dropdown  box-shadow" data-aos="fade-in">
					  <a class="nav-link dropdown-toggle" style="box-shadow: 0 1px 8px 0 salmon, 0 5px 10px 0 black;background-color:SALMON;color:white;" href="#" id="navbardrop" data-toggle="dropdown">
					  ...
					  <div class="dropdown-menu">
						...
						<a class="dropdown-item  nav-elevate" style="border-left: 6px solid pink;" href="#">Homemade Delights</a>
						<a class="dropdown-item  nav-elevate" style="border-left: 6px solid yellow;" href="street.php">Street Food</a>
					  </div>
					</li>
		...
		<!--Items-->
		<div class="container-fluid" style="background: SALMON;box-shadow: 0px 0px 20px rgba(0, 0, 0, 0.2), 0px 0px 20px rgba(0, 0, 0, 0.19);">
			</br></br>
			<div class="col-lg-4 offset-lg-4">
				<center>
				<h1 data-aos="" style="-webkit-box-shadow: inset -1px -2px 47px -2px rgba(184,4,34,1);
-moz-box-shadow: inset -1px -2px 47px -2px rgba(184,4,34,1);
box-shadow: inset -1px -2px 47px -2px rgba(184,4,34,1);;font-family:'Cabin Sketch';color:white;padding:2px;">Home - made Delights</h1>
				</center>
			</div>
			<div class="row">	
				<div class="col-lg-3 col-6"  data-aos="fade-up">  
					</br></br>
					<div class="card box-shadow elevate" style="box-shadow: 0 1px 8px 0 salmon, 0 10px 20px 0 #943126  ;" data-toggle="modal" data-target="#myModal1">
						<div class="card-body">
					...
					<div class="modal-body">
						...
						<?php if (!isset($_SESSION['email'])) { ?>
                                ...
                                if (check_if_added_to_cart(9)) { //This is same as if(check_if_added_to_cart != 0)
                                    ...
                                    ?>
                                    <a href="cart-add.php?id=9" name="add" value="add" class="btn btn-warning box-shadow">Add to cart</a>
                                    <?php
                                }
                            }
							?>
					...
					<div class="modal-body">
						...
						<?php if (!isset($_SESSION['email'])) { ?>
                                ...
                                if (check_if_added_to_cart(10)) { //This is same as if(check_if_added_to_cart != 0)
                                    ...
                                    ?>
                                    <a href="cart-add.php?id=10" name="add" value="add" class="btn btn-warning box-shadow">Add to cart</a>
                                    <?php
                                }
                            }
							?>
					...
					<div class="modal-body">
					    ...
					    <?php if (!isset($_SESSION['email'])) { ?>
                                ...
                                if (check_if_added_to_cart(11)) { //This is same as if(check_if_added_to_cart != 0)
                                    ...
                                    ?>
                                    <a href="cart-add.php?id=11" name="add" value="add" class="btn btn-warning box-shadow">Add to cart</a>
                                    <?php
                                }
                            }
							?>
					...
					<div class="modal-body">
					    ...
					    <?php if (!isset($_SESSION['email'])) { ?>
                                ...
                                if (check_if_added_to_cart(12)) { //This is same as if(check_if_added_to_cart != 0)
                                    ...
                                    ?>
                                    <a href="cart-add.php?id=12" name="add" value="add" class="btn btn-warning box-shadow">Add to cart</a>
                                    <?php
                                }
                            }
							?>
