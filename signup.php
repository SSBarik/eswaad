...
if (isset($_SESSION['email'])) {
    header('location: index.php#proudcts');
}
?>
<!DOCTYPE html>
<html lang="en">
			...
			<div class="collapse navbar-collapse  justify-content-end" id="collapsibleNavbar">
                ...
                if (isset($_SESSION['email'])) {
                    ...
                    <li class="nav-item" data-aos="fade-in">
						<a class="nav-link"  style="box-shadow: 0 1px 8px 0 grey, 0 5px 10px 0 black;background-color:lightgrey;color:white;"  href="signup.php"><i class="fas fa-user-plus"></i> <span style="color:#FFFDE7;">SignUp</span></a>
					</li>
					<li class="nav-item">
			...
			<div class="row">
                <div class="container">
                    <div class="col-lg-4 offset-lg-4 col-md-6 offset-md-3">
                        <h2 data-aos="zoom-out">SiGN UP</h2>
                        <form  action="signup_script.php" method="POST">
                            <div data-aos="fade-up" data-aos="fade-up" class="form-group">
                            ...
                            <button data-aos="fade-right" type="submit" name="submit" class="btn btn-primary box-shadow float-right">Submit</button>
                        </form>
                    </div>
                </div>
            </div>
