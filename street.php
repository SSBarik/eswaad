			...
			<div class="collapse navbar-collapse  justify-content-end" id="collapsibleNavbar">
				<ul class="navbar-nav" data-aos="";>
					...
					<li class="nav-item dropdown  box-shadow" data-aos="fade-in">
					  <a class="nav-link dropdown-toggle" style="box-shadow: 0 1px 8px 0 brown, 0 5px 10px 0 black;background-color:orange;color:white;" href="#" id="navbardrop" data-toggle="dropdown">
...
box-shadow: inset -1px -2px 47px -2px rgba(46,6,6,1);font-family:'Cabin Sketch';color:white;padding:2px;" >Street Food</h1>
				</center>
			</div>
			<div class="row">	
